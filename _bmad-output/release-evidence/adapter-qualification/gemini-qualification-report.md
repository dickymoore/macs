...
- Runtime binary or backend tested: gemini
...
- Known unsupported features: token_budget, runtime_checkpoints
...
- Unsupported intervention behaviors: token_budget, runtime_checkpoints
...
| --- | --- | --- | --- | --- |
| degraded_mode_behavior | Treats missing runtime signals as degraded and preserves only required pane and capability facts. | n/a | required | shared contract declaration |
| unsupported_features | token_budget, runtime_checkpoints | n/a | optional | explicit unsupported declaration |
...
- Example inspector output: `macs adapter inspect --adapter gemini --json`
