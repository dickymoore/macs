...
- Runtime binary or backend tested: local
...
- Known unsupported features: token_budget, structured_progress, delivery_metadata
...
- Unsupported intervention behaviors: token_budget, structured_progress, delivery_metadata
...
| --- | --- | --- | --- | --- |
| degraded_mode_behavior | Keeps routing local-first and relies on tmux facts plus declared capabilities in low-signal mode. | n/a | required | shared contract declaration |
| unsupported_features | token_budget, structured_progress, delivery_metadata | n/a | optional | explicit unsupported declaration |
...
- Example inspector output: `macs adapter inspect --adapter local --json`
